...
export BERT_BASE_DIR=/home/redis/model/chinese_L-12_H-768_A-12 #全局变量
export MY_DATASET=/home/redis/hbfeng/ccks/result/v4 #全局变量
export MODEL_OUTPUT=/home/redis/hbfeng/ccks/result/v4/bert/entity_link_model
export VALID_OUTPUT=/home/redis/hbfeng/ccks/result/v4/bert/entity_link_model/valid
export DEVELOP_OUTPUT=/home/redis/hbfeng/ccks/result/v4/bert/entity_link_model/develop

cpu:
python run_classifier_with_ccks.py --task_name=ccks_sim --do_train=true --do_eval=true --do_predict=true --data_dir=$MY_DATASET --vocab_file=$BERT_BASE_DIR/vocab.txt --bert_config_file=$BERT_BASE_DIR/bert_config.json --init_checkpoint=$BERT_BASE_DIR/bert_model.ckpt --max_seq_length=128  --train_batch_size=8 --learning_rate=5e-5 --num_train_epochs=10.0 --output_dir=$MODEL_OUTPUT &
gpu:
